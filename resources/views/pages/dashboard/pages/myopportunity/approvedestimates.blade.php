  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Approved Estimates</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        @if (count($data['approvedestimate']) > 0)
            @foreach ($data['approvedestimate'] as $item)
            <div class="col-md-12">
                <!-- Box Comment -->
                <div class="box box-widget">
                  ...
                  <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <p>Vehicle Licence: {{ $item->post_licence }}</p>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        @if ($item->work_order == 0)
                        <div class="col-md-12">
                            <button type="button" class="btn btn-success btn-block">Close to Work Order</button>
                        </div>
                        @else
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary btn-block">View full detail</button>
                        </div>
                        @endif

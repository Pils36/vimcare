                ...
                <div class="row">
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            ...
                            <a href="{{ route('view appointments') }}" class="small-box-footer">View appointments <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                            <div class="inner">
                                <h3>{{ count($data['opportunityPost']) }}</h3>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                            <div class="inner">
                                <h3>{{ count($data['approvedEstimate']) }}</h3>

                                <p>Approved Estimates</p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-pie-graph"></i>
                            </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-red">
                            <div class="inner">
                                <h3>{{ count($data['submitedEstimate']) }}</h3>

                                <p>Submitted Estimates</p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-stats-bars"></i>
                            </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-orange">
                            <div class="inner">
                                <h3>{{ count($data['phoneAppointment']) }}</h3>

                                <p>Phone Appointment List</p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-stats-bars"></i>
                            </div>
